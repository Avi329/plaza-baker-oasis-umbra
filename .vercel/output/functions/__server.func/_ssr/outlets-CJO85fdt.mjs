//#region node_modules/.nitro/vite/services/ssr/assets/outlets-CJO85fdt.js
var NEWS_OUTLETS = [
	{
		name: "Breitbart",
		hosts: ["breitbart.com"],
	...
	{
		name: "Daily Mail",
		hosts: ["dailymail.co.uk", "dailymail.com"],
		lean: "right"
	},
	{
		name: "The Telegraph",
	...
	{
		name: "The Federalist",
		hosts: ["thefederalist.com"],
		lean: "right"
	},
	{
		name: "Washington Examiner",
		hosts: ["washingtonexaminer.com"],
		lean: "right"
	},
	{
		name: "Townhall",
	...
	{
		name: "The Spectator",
		hosts: ["spectator.co.uk", "spectator.org"],
		lean: "right"
	},
	{
		name: "Newsmax",
	...
	{
		name: "Daily Caller",
		hosts: ["dailycaller.com"],
		lean: "right"
	},
	{
		name: "Washington Times",
		hosts: ["washingtontimes.com"],
		lean: "right"
	},
	{
		name: "GB News",
		hosts: ["gbnews.com", "gbnews.uk"],
		lean: "right"
	},
	{
		name: "The Hill",
...
NEWS_OUTLETS.map((o) => o.name);
var CONSERVATIVE_DESKS = NEWS_OUTLETS.filter((o) => o.lean === "right").map((o) => o.name);
var COMMENT_PLATFORMS = [
	"Disqus",
	"OpenWeb / Spot.IM",
	"Viafoura",
	"Coral",
...
function outletLean(name) {
	if (!name) return void 0;
	const s = name.toLowerCase();
	if (s.includes("disqus") || s.includes("openweb") || s.includes("spot.im")) return "center";
	return NEWS_OUTLETS.find((o) => s.includes(o.name.toLowerCase()) || o.hosts.some((h) => s.includes(h)))?.lean;
}
/** Modest ranking bump so conservative desks take more of the floor. */
function conservativeBoost(name) {
...
function isNewsOutletName(value) {
	...
	if (s.includes("disqus") || s.includes("openweb") || s.includes("viafoura") || s.includes("coral")) return true;
	return NEWS_OUTLETS.some((o) => s.includes(o.name.toLowerCase()) || o.hosts.some((h) => s.includes(h)));
}
//#endregion
export { outletFromUrl as a, isNewsOutletName as i, CONSERVATIVE_DESKS as n, conservativeBoost as r, COMMENT_PLATFORMS as t };
